...
[![Pack build](https://img.shields.io/github/actions/workflow/status/Open-CMSIS-Pack/Sensor-SDK-Example/pack.yml?logo=arm&logoColor=0091bd&label=Build%20pack)](https://github.com/Open-CMSIS-Pack/Sensor-SDK-Example/tree/main/.github/workflows/pack.yml)
